    ...
    <div class="row">
      <div class="col">
        <div class="card text-center p-3 mb-3 bg-white ml-0 border-0 col-md-8 mt-3">
            <div class="card-body">
              <img src="<?php echo path;?>img/portal/svg/001-adoption.svg" class="card-img-top mb-4"  width="95" height="95" alt="...">
              <h2 class="card-title font-weight-bold text-success" >Soy un propietario</h2>
